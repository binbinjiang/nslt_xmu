...
if __name__ == "__main__":
    my_weights_path = '../BaseModel/bvlc_alexnet.npy'
    my_weights_dict = np.load(my_weights_path, encoding='bytes').item()
    sum = 0
    for key in my_weights_dict:
        l0 = my_weights_dict[key][0].shape
        l1 = my_weights_dict[key][1].shape
        sum += l0[0]*l0[1]+l1[0]

    print(sum*32/1024/1024/1024)
        # print(my_weights_dict['fc8'][0].shape)
        # print(my_weights_dict['fc8'][1].shape)
